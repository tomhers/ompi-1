 ...
 */
const char *opal_pmix_pmix4x_component_version_string =
    "OPAL pmix4x MCA component version " OPAL_VERSION;
...
mca_pmix_pmix4x_component_t mca_pmix_pmix4x_component = {
    {
...
static int external_register(void)
{
    mca_base_component_t *component = &mca_pmix_pmix4x_component.super.base_version;
    char *tmp = NULL;

    mca_pmix_pmix4x_component.silence_warning = false;
    (void) mca_base_component_var_register (component, "silence_warning",
                                            "Silence warning about PMIX_INSTALL_PREFIX",
                                            MCA_BASE_VAR_TYPE_BOOL, NULL, 0, 0,
                                            OPAL_INFO_LVL_4,
                                            MCA_BASE_VAR_SCOPE_READONLY,
                                            &mca_pmix_pmix4x_component.silence_warning);
...
static int external_open(void)
{
    ...
    mca_pmix_pmix4x_component.evindex = 0;
    OBJ_CONSTRUCT(&mca_pmix_pmix4x_component.jobids, opal_list_t);
    OBJ_CONSTRUCT(&mca_pmix_pmix4x_component.events, opal_list_t);
    OBJ_CONSTRUCT(&mca_pmix_pmix4x_component.dmdx, opal_list_t);
...
static int external_close(void)
{
    OPAL_LIST_DESTRUCT(&mca_pmix_pmix4x_component.jobids);
    OPAL_LIST_DESTRUCT(&mca_pmix_pmix4x_component.events);
    OPAL_LIST_DESTRUCT(&mca_pmix_pmix4x_component.dmdx);
...
static int external_component_query(mca_base_module_t **module, int *priority)
{
    ...
    *module = (mca_base_module_t *)&opal_pmix_pmix4x_module;
    return OPAL_SUCCESS;
}
